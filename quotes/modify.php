...
// Establishes the session and checks for if the user is signed in.
// If the user is not signed in, will redirect them to the sign-in page in order to sign in to their account.
...
<html lang="en">
	...
	<body style="text-align:center;">
		...
		<p>
			<?php
			// Reads in the quotes files into an array. Then gives the author+quote pair as provided by the session variable index.
			...
			<p><?= $quotes[$_POST['index']]['Author'] ?></p>
			 ...
			 <?php
				...
				// If the user confirms wanting to modify the quote and author pair listed, calls upon the modifyLine function to alter the line in the quotes.csv folder.
			...
			?>
				...
				<!-- Hides the modify form so that an unlogged in user cannot modify the quote+author pair -->
			...
			<br><br>
				...
				<!-- Provides a link for the user to return to the home page -->
