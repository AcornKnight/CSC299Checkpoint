...
// User entry form to create an account
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <div class="container">
	...
	<!-- Checks to make sure all fields are entered. Then if all are, makes sure both passwords are the same to set the password -->
<?php
	if ((isset($_POST['email'])) {
