...
<html lang="en">
	...
	<body style="text-align:center;">
		...
		<p>
			...
			<!-- Provides a button to return the user to the author homepage. -->
			...
			<!-- A hidden form that if a signed in user is on the page, will display options for the user deleting and modifying an author-->
			<form method="post"	action="<?= $_SERVER['PHP_SELF']?>">
				<br><br>
				<p>
